const contractAddress = "0x5B1f8A31F584381fD627Ee1e808f0Ccc490CB88E"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the FunScles NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'FnS is a collection of 10,000 FunSicles,unique digital collectibles living on the Polygon blockchain. Your FunSicle is also a Keycard, and grants access to members-only benefits,👉<a href="https://dev-funsicles.pantheonsite.io/"  target="_blank" rel="noopener noreferrer">FunSicles</a> YouTube channel.';
...
const button_public_mint = "Mint Your FunSicle";
